...
<div class="gbBlock">
  ...
  <p class="gbDescription">
    ...
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:clipboardData.setData('Text','&lt;a href=&quot;{g->url arg1="view=core.ShowItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot;&gt;click for image&lt;/a&gt;');window.status = '[CLK]{$GetUrlsData.itemId}[/CLK] copied to your clipboard for forum posting!';" href>[{g->text text="CLK"}]</a>{/if}
  </p>
  {/if}
  ...
  <p class="gbDescription">
    ...
    <br />
    <input onclick="this.focus(); this.select();" name="forum" type="text" readonly="true" size="{$width}" value="&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.resizeId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot; alt=&quot;{$itemTitle}&quot; /&gt;">
  ...
  <p class="gbDescription">
    ...
    <br />
    <input onclick="this.focus(); this.select();" name="forum" type="text" readonly="true" size="{$width}" value="&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.resizeId`" forceFullUrl=true}&quot; alt=&quot;{$itemTitle}&quot; /&gt;">
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:clipboardData.setData('Text','&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.resizeId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot; alt=&quot;{$itemTitle}&quot; /&gt;');window.status = '[IMG]{$GetUrlsData.itemId}[/IMG] copied to your clipboard for forum posting!';" href>[IMG]</a>{/if}
  </p>
  {/if}
  {/if}
  ...
  <p class="gbDescription">
    ...
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:clipboardData.setData('Text','&lt;a href=&quot;{g->url arg1="view=core.ShowItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot;&gt;&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.thumbId`" forceFullUrl=true forceSessionId=false}&quot; alt=&quot;{$itemTitle}&quot; /&gt;&lt;/a&gt;');window.status = '[TMB]{$GetUrlsData.thumbId}[/TMB] copied to your clipboard for forum posting!';" href>[{g->text text="TMB"}]</a>{/if}
  </p>
  {/if}
</div>
{/if}
...
<div class="gbBlock">
  ...
  <p class="gbDescription">
    ...
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:clipboardData.setData('Text','[url={g->url arg1="view=core.ShowItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false htmlEntities=false}]click for image[/url]');window.status = '[CLK]{$GetUrlsData.itemId}[/CLK] copied to your clipboard for forum posting!';" href>[{g->text text="CLK"}]</a>{/if}
  </p>
  {/if}
  ...
  <p class="gbDescription">
    ...
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:clipboardData.setData('Text','[url={g->url arg1="view=core.ShowItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false htmlEntities=false}][img]{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.thumbId`" forceFullUrl=true forceSessionId=false}[/img][/url]');window.status = '[TMB]{$GetUrlsData.thumbId}[/TMB] copied to your clipboard for forum posting!';" href>[{g->text text="TMB"}]</a>{/if}
  </p>
  {/if}
</div>
{/if}
...
<div class="gbBlock">
  ...
  <p class="gbDescription">
    ...
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:clipboardData.setData('Text','{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false htmlEntities=false}');window.status = 'http link to Full Item ID {$GetUrlsData.itemId} copied to your clipboard!';" href>[IMG]</a>{/if}   </p>
  </p>
  {/if}
  {/if}
  ...
  <p class="gbDescription">
    ...
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:clipboardData.setData('Text','{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.thumbId`" forceFullUrl=true forceSessionId=false htmlEntities=false}');window.status = 'http link to Thumb Item ID {$GetUrlsData.thumbId} copied to your clipboard!';" href>[IMG]</a>{/if}   </p>
  </p>
  {/if}
</div>
{/if}
