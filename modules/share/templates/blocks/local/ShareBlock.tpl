...
<span style="float:left">{g->text text="Comparte:"} 
</span><a class="addthis_button_facebook"></a>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ahpn" async="async"></script>
<!-- AddThis Button END -->
