...
<form action="{g->url}" method="post" enctype="application/x-www-form-urlencoded"
 id="addCommentForm">
  ...
  <div class="gbBlock">
    ...
    <input type="text" id="author" size="60" class="InputBg"
	   name="{g->formVar var="form[author]"}" value="{$form.author}"
	   onfocus="this.className=''" onblur="this.className='InputBg'"/>
    {else}
    ...
    <input type="text" id="subject" size="60" class="InputBg"
    ...
    <textarea rows="10" cols="80" id="comment" class="InputBg"
      name="{g->formVar var="form[comment]"}"
      onfocus="this.className=''" onblur="this.className='InputBg'">{$form.comment}</textarea>
