...
class TagsHelper {
	...
	return GalleryCoreApi::addMapEntry('TagItemMap', array('itemId' => $itemId, 
	    'tagId' => $tagId));
    }
	...
	return GalleryCoreApi::removeMapEntry('TagItemMap', array('itemId' => $itemId));
    }
	...
	return GalleryCoreApi::updateMapEntry('TagMap', array('tagName' => $oldName),
