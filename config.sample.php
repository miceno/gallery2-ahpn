 ...
 */
$gallery->setConfig('data.gallery.base', 'GALLERY_BASE_PATH');
...
// $gallery->setDebugLogFile('GALLERY_BASE_PATH/debug.log');
 ...
 */
$gallery->setConfig('baseUri', 'https://SUBDOMAIN.DOMAIN/main.php');
?>
