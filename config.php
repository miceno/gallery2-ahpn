 ...
 */
$gallery->setConfig('setup.password', 'XXXXXXXX');
 ...
 */
$gallery->setConfig('data.gallery.base', '/private/fotos/');
...
// $gallery->setDebugLogFile('/private/fotos/debug.log');
 ...
 */
$gallery->setConfig('baseUri', 'https://localhost/main.php');
?>
