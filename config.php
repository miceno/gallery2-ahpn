 ...
 */
$gallery->setConfig('setup.password', 'oronegro');
 ...
 */
$gallery->setConfig('data.gallery.base', '/homepages/8/d228439513/htdocs/private/gallery2-data/');
...
$storeConfig['hostname'] = 'db456774824.db.1and1.com';
$storeConfig['database'] = 'db456774824';
$storeConfig['username'] = 'dbo456774824';
$storeConfig['password'] = '9arxiu8';
$storeConfig['schema'] = '';
...
$gallery->setDebugLogFile('/kunden/homepages/8/d228439513/htdocs/private/gallery2-data/log');
 ...
 */
// $gallery->setConfig('baseUri', 'http://fotos.arxiuhistoricpoblenou.es/main.php');
$gallery->setConfig('baseUri', 'http://' . $_SERVER["HTTP_HOST"] . '/main.php')
?>
